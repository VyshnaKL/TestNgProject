...
public class FakerClass extends Base {
	...
	public void  verifyFakerClass() {
		...
		// To generate valid random user name
		System.out.println("Username is " +faker.name().username());
		// To generate valid random Password
		System.out.println("Password is" +faker.internet().password());
		// To generate valid random EmailAddress
		...
		System.out.println("EmailAddress" +faker.bothify("Amod##167??789"));
